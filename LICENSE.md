...
Utilizzando il software, accetti integralmente tutti i termini e le condizioni riportati di seguito.
...
- Fornire il software a terzi come servizio ospitato o gestito, qualora tale servizio consenta agli utenti di accedere a una parte sostanziale delle funzionalità del software.
...
Devi garantire che chiunque riceva da te una copia di qualsiasi parte del software riceva anche una copia di questi termini.
...
Il **licenziante** è l'entità che offre questi termini, e il **software** è il software che il licenziante mette a disposizione ai sensi dei presenti termini, inclusa qualsiasi sua parte.

**Tu** indica la persona fisica o giuridica che accetta i presenti termini.

La **tua azienda** è qualsiasi entità giuridica, ditta individuale o altra forma organizzativa per cui lavori, nonché tutte le organizzazioni che controllano, sono controllate da, o sono soggette al controllo comune di tale organizzazione. Il **controllo** indica la proprietà della quasi totalità degli asset di un'entità, o il potere di dirigerne la gestione e le politiche tramite voto, contratto o altro mezzo. Il controllo può essere diretto o indiretto.

Le **tue licenze** sono tutte le licenze che ti sono concesse per il software ai sensi dei presenti termini.

L'**utilizzo** indica qualsiasi azione tu compia con il software che richieda una delle tue licenze.

Il **marchio** indica marchi commerciali, marchi di servizio e diritti analoghi.
